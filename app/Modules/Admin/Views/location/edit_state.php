                ...
                <div class="card-body">
                    <form name="newcatForm" action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?=$res_arr['location_name']?>" name="state_name" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label text-dark">State Display Name</label>
                            <input type="text" class="form-control" value="<?=$res_arr['location_display']?>" name="state_name_p" required>
                        </div>
                     <div class="form-group">
