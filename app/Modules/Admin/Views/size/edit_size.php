                ...
                <div class="card-body">
                    <form name="newcatForm" action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?=$sizeRes['size_name']?>" name="size_name" required>
                        </div>
                      
                     <div class="form-group">
                         <input type="hidden" class="form-control" name="action" value="edit">
                        <button class="btn save_btn" type="submit">Save</button>
                         <a href="<?=admin_url('manage-size')?>" class="btn cancel_btn" title="Cancel">Cancel</a>
                    </div>
                </form>
             </div>
        </div>
