            ...
            <?php if(isset($validation)):?>
                ...
                <div class="form-group">
                    <label class="form-label text-dark">Banner Title</label>
                        <input type="text" class="form-control" name="banner_title" placeholder="Banner Title" value="<?=$bannerRes['banner_title']?>" required="">
                </div>
                <div class="form-group">
                    <label class="form-label text-dark">Banner URL</label>
                        <input type="text" class="form-control" name="banner_url" placeholder="Banner url" value="<?=$bannerRes['banner_url']?>" required="">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="form-label text-dark">*Banner For Mobile</label>
                        <input type="file" class="form-control" name="mobile_banner_image" >
                </div>
                <div class="form-group">
