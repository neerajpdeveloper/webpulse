                ...
                <div class="card-body">
                    <form name="newcatForm" action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="faq_question" required="" value="<?=$faqres['faq_question']?>">
                        </div>
                        <div class="form-group">
                             <label class="form-label text-dark">FAQ Answer</label>
                              <textarea class="form-control" name="faq_answer" required><?=$faqres['faq_answer']?></textarea>
                         </div>
