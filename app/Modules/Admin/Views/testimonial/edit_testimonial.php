                ...
                <div class="card-body">
                    <form name="newcatForm" action="" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="testimonial_title" value="<?=$testimonialres['testimonial_title']?>" required>
                            </div>
                              <div class="form-group">
                                <label class="form-label text-dark">Testimonial Designation</label>
                                <input type="text" class="form-control" name="designation" value="<?=$testimonialres['designation']?>" required>
                            </div>
                              <div class="form-group">
                                <label class="form-label text-dark">Testimonial Location</label>
                                <input type="text" class="form-control" name="location" value="<?=$testimonialres['location']?>">
                            </div>
                               <div class="form-group">
                                 <label class="form-label text-dark">Testimonial Short Description</label>
                                 <textarea class="form-control" name="testimonial_shortdesc" required><?=$testimonialres['testimonial_shortdesc']?></textarea>
                             </div>
                                
                            <div class="form-group">
                            <label class="form-label text-dark">Testimonial Full Description</label>
                            <textarea  class="form-control editor" name="testimonial_description"><?=$testimonialres['testimonial_description']?></textarea>
                                </div>
                            <div class="form-group">
                                    <label class="form-label text-dark">Author Image</label>
                                        <input type="file" class="form-control" name="testimonialimg" >
                                </div>
