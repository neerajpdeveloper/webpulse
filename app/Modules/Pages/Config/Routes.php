...
$routes->group('/', ['namespace' => 'App\Modules\Pages\Controllers'], function($subroutes) use ($db){
    ...
    $routes_array = $db->table('wps_meta_tags')->where('is_fixed','Y')->where('page_url', $uri_aligs_string)->get()->getResultArray();
    if($routes_array){
